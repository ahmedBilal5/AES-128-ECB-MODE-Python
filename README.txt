...
3b. if option 2 is selected, a random key from  'key_file.key' will be selected and a random plaintext from 'plaintext.pt' will be selected. Encyption and decryption       will be perfomed and the encryption PLUS decryption rate in (MB/s) will be calculated.
